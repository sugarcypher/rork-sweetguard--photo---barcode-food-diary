...
export const SUGAR_SEVERITY = {
  LOW: { threshold: 5, color: '#34C759', label: 'Low' }, // 0-5g
  MEDIUM: { threshold: 15, color: '#FFCC00', label: 'Moderate' }, // 5-15g
  HIGH: { threshold: 25, color: '#FF9500', label: 'High' }, // 15-25g
  VERY_HIGH: { threshold: Infinity, color: '#FF3B30', label: 'Very High' }, // >25g
};
